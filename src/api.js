...
export const getInventory = (id, membershipType, token = cookie.getToken()) => _axios.get(
    `/Platform/Destiny2/${membershipType}/Profile/${id}/?components=100%2C102%2C103%2C200%2C201%2C202%2C205%2C300%2C301%2C304%2C305%2C306%2C307%2C800%2C308%2C310%2C309%2C900`,
